...
<meta property="og:image" content="<% if $Object %><% if $Object.AltImage %>$Object.AltImage.ScaledImage.AbsoluteURL <% else %>$Object.Image.ScaledImage.AbsoluteURL<% end_if %><% else %>http://africa.uima.uiowa.edu/themes/africa/images/opengraph.jpg<% end_if %>">
