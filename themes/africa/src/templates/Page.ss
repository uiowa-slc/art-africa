...
<html lang="$ContentLocale">
  <head>
    <% base_tag %>
    <title><% if not $Object %>$Title<% else %>$Object.Title<% end_if %><% if $EssayPages || $Object.EssayPages %>, Page <% loop $getPaginatedPages %>$PageNo<% end_loop %><% end_if %> -  Art &amp; Life in Africa - The University of Iowa Stanley Museum of Art</title>
        ...
        <div id="footer" class="padded">
          <div class="container-fluid">
            ...
            <div class="span4">
              <div>
              <p>
              <a href="http://uima.uiowa.edu" target="_blank"><img src="{$ThemeDir}/dist/images/UISMA_lockup_black.png" alt="University of Iowa Stanley Museum of Art" class="uima-logo"></a>
              </p>
