    ...
    <nav class="nav2 interior-page">
      <% if $Action =="SearchForm" %>
        <div id="quick-links-container">
          ...
          <hr />
          <h3>Search for "{$Query}" on other websites:</h3>
            <ul class="quick-links">
                <li><a href="http://www.google.com/search?q=site:anthro.amnh.org+$Query" target="_blank">American Museum of Natural History</a></li>
                <li><a href="http://www.google.com/search?q=site:artic.edu+$Query" target="_blank">Art Institute of Chicago</a></li>
                <li><a href="http://www.google.com/search?q=site:artbma.org+$Query" target="_blank">Baltimore Museum of Art</a></li>
                <li><a href="http://www.google.com/search?q=site:barnesfoundation.org+$Query" target="_blank">Barnes Foundation</a></li>                
