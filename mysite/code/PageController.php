...
class PageController extends ContentController {
    ...
    function results( $data, $form, $request ) {
        ...
        //print_r(FulltextSearchable::get_searchable_classes());
    ...
    public function show( $request ) {
        ...
        if ( $objectID ) {
            ...
            if ( $object ) {
                ...
                if(($object->ClassName == Image::class) &&  ($object->ParentImage())){
    ...
    public function SearchForm()
    {
        ...
        $searchForm = SearchForm::create($this->owner, 'SearchForm', $fields, $actions);
        $searchForm->setTemplate('Includes/SearchForm');
        return $searchForm;
    }
    ...
    static public function imageHandler( $arguments ) {
        ...
        if ( $photoObject ) {
            $template = new SSViewer( 'Includes/EmbeddedImage' );
    ...
    static public function shortCodeHandler( $arguments, $class ) {
        ...
        if ( isset( $arguments["size"] ) ) {
            $newObject->setField( 'size', $arguments["size"] . Image::class ); //size is (for instance) medium, CSS class for sizing the image in the template is mediumImage
        }
        else {
